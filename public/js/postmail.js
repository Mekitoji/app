  ...
  .success(function (data) {
    ...
    Apps.getCalendar()
      .success(function (c) {
        ...
        $scope.previewText += "\n</table><br />\n\n" +
          "You can now check current Pass Rate in <a href=" + $scope.url + "/" + $scope.region + "/" + $scope.year + "/rejected#/inwork' >Gk Control System </a>as well as detailed statistics. In cast uou don't have access, reply to this email and request authority." +
          "<a href='" + $scope.url + "/" + $scope.region + "/" + $scope.year + "/tester'><img width='480' src='" + $scope.url + "/images/charts/" + generateChartName() +"'></a><br><br>" +
          "Best wishes, <br />\n\n\n CIS STE Team<br><br>" +
