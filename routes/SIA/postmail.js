...
module.exports = function (app) {
  app.get('/sia/:year/postmail', routesFunction.checkPermissionGkSIA, function (req, res, next) {
  ...
  app.post('/sia/postmail', routesFunction.checkPermissionGkSIA, function (req, res) {
