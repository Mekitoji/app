...
module.exports = function (app) {
  app.get('/sia/history/:date/tester', routesFunction.checkPermissionGkSIA, function (req, res) {
  ...
  app.get('/sia/history/:date/tester/:tester_id', routesFunction.checkPermissionGkSIA, function (req, res) {
    var date = req.params.date;
