...
module.exports = function (app) {
  app.get('/ciseu/:year/postmail', routesFunction.checkPermissionGkCISEU, function (req, res, next) {
  ...
  app.post('/ciseu/postmail', routesFunction.checkPermissionGkCISEU, function (req, res) {
