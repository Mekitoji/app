...
module.exports = function (app) {
  app.get('/ciseu/:year/tester', routesFunction.checkPermissionCISEU, function (req, res) {
  ...
  app.post('/ciseu/:year/tester', routesFunction.checkPermissionGkCISEU, function(req, res) {
    ...
    var mailOptions = {
      from: 'CIS & EU STE <noreply@lge.com>', // sender address
