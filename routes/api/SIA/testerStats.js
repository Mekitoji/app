...
module.exports = function (app) {
  app.get('/api/sia/testerStat', function (req, res) {
    TesterStat.find({})
      .populate('user')
  ...
  app.post('/api/sia/testerStat', function (req, res) {
  ...
  app.put('/api/sia/testerStat/insertCycle/:tester_id', function (req, res) {
    console.log(req.body);
  ...
  app.put('/api/sia/testerStat/:tester_id', function (req, res) {
    //get tester by id
    TesterStat.findById(req.params.tester_id, function (err, tester) {
      if (err) {
        throw err;
  ...
  app.delete('/api/sia/testerStat/:tester_id', function (req, res) {
    TesterStat.remove({
