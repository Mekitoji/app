...
module.exports = function (app) {
  ...
  //GET data in json
  app.get('/api/sia/calendar', function (req, res) {
  ...
  app.get('/api/sia/calendar/approved', function (req, res) {
  ...
  app.get('/api/sia/calendar/rejected', function (req, res) {
    var rejectedApp;
  ...
  app.get('/api/sia/calendar/outdated', function (req, res) {
    var outdatedApp;
    Apps.find(function (err, app) {
      var outdated = [];
      // if there is an error retrieving, send the error. nothing after res.send(err) will execute
  ...
  app.put('/api/sia/calendar/:calendar_id', function (req, res) {
