...
var ApprovedCal = require('../../../models/SIA/calendarForApprovedApps');
...
module.exports = function (app) {
  ...
  //get all
  app.get('/api/sia/gk', function (req, res) {
    ...
    Apps.find(function (err, app) {
      ...
      log.info(new Date() + '  - GET /API/sia/GK');
    });
  });

  app.get('/api/sia/gk/notReviewed', function (req, res) {
  ...
  //rejected filter
  app.get('/api/sia/gk/rejected', function (req, res) {
    ...
    Apps.find(function (err, app) {
      ...
      log.info(new Date() + '  - GET /API/sia/GK/REJECTED');
    });
  });

  //approved filter
  app.get('/api/sia/gk/approved', function (req, res) {
  ...
  //outdated filter
  app.get('/api/sia/gk/outdated', function (req, res) {
    ...
    Apps.find(function (err, app) {
      ...
      log.info(new Date() + '  - GET /API/sia/GK/OUTDATED');
    });
  });


  app.get('/api/sia/gk/:app_id', function (req, res) {
  ...
  app.post('/api/sia/gk', function (req, res) {
    ...
    Apps.create({
      ...
      Apps.find({
        ...
        cal.save(function (err, data) {
          if (err) res.send(err);
          res.json(data);
          log.info(new Date() + '  - POST /API/sia/GK/' + data.appId);
        });
      });
    });
  });
  ...
  // delete a user
  app.delete('/api/sia/gk/:app_id', function (req, res) {
    Apps.remove({
  ...
  //update a user
  app.put('/api/sia/gk/:app_id', function (req, res) {
