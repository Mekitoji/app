...
module.exports = function (app) {
  ...
  //GET data in json
  app.get('/api/ciseu/calendar', function (req, res) {
  ...
  app.get('/api/ciseu/calendar/approved', function (req, res) {
  ...
  app.get('/api/ciseu/calendar/rejected', function (req, res) {
    var rejectedApp;
  ...
  app.get('/api/ciseu/calendar/outdated', function (req, res) {
    var outdatedApp;
    Apps.find(function (err, app) {
      var outdated = [];
      // if there is an error retrieving, send the error. nothing after res.send(err) will execute
  ...
  app.put('/api/ciseu/calendar/:calendar_id', function (req, res) {
