var TesterStat = require('../../../models/CISEU/testerStat');
...
module.exports = function (app) {
  app.get('/api/ciseu/testerStat', function (req, res) {
    TesterStat.find({})
      .populate('user')
  ...
  app.post('/api/ciseu/testerStat', function (req, res) {
  ...
  app.put('/api/ciseu/testerStat/insertSecondCycle/:tester_id', function(req, res) {
  ...
  app.put('/api/ciseu/testerStat/insertCycle/:tester_id', function (req, res) {
  ...
  app.put('/api/ciseu/testerStat/:tester_id', function (req, res) {
    //get tester by id
    TesterStat.findById(req.params.tester_id, function (err, tester) {
      if (err) {
        throw err;
  ...
  app.delete('/api/ciseu/testerStat/:tester_id', function (req, res) {
    TesterStat.remove({
