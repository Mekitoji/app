...
module.exports = function (app) {
  ...
  app.post('/api/eu/tester', function (req, res) {
    Tester.create({
  ...
  app.put('/api/eu/tester/:tester_id', function (req, res) {
