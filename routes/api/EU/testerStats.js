...
module.exports = function (app) {
  ...
  app.post('/api/eu/testerStat', function (req, res) {
  ...
  app.put('/api/eu/testerStat/insertCycle/:tester_id', function (req, res) {
    console.log(req.body);
  ...
  app.put('/api/eu/testerStat/:tester_id', function (req, res) {
    //get tester by id
    TesterStat.findById(req.params.tester_id, function (err, tester) {
      if (err) {
        throw err;
  ...
  app.delete('/api/eu/testerStat/:tester_id', function (req, res) {
    TesterStat.remove({
